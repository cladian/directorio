 ...
 *
 * The followings are the available columns in table 'coberturas':
 * @property integer $id
 ...
 */
class Coberturas extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('provincias_id, registros_id', 'required'),
			array('id, provincias_id, status, registros_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, provincias_id, status, registros_id', 'safe', 'on'=>'search'),
			// Valores por defecto
    ...
    public function searchByCoberturas($id)
    {
        // @todo Please modify the following code to remove attributes that should not be searched.

        $criteria=new CDbCriteria;

        $criteria->with=array('provincias');
	 ...
	 * @return Coberturas the static model class
	 */
