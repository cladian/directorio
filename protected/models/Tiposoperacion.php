...
/**
 * This is the model class for table "tiposoperacion".
 *
 * The followings are the available columns in table 'tiposoperacion':
 * @property integer $id
 ...
 */
class Tiposoperacion extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'consorcioses' => array(self::HAS_MANY, 'Consorcios', 'tiposoperacion_id'),
		);
	}
	 ...
	 * @return Tiposoperacion the static model class
	 */
