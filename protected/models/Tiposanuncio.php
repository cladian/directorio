...
/**
 * This is the model class for table "tiposanuncio".
 *
 * The followings are the available columns in table 'tiposanuncio':
 * @property integer $id
 ...
 */
class Tiposanuncio extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'anuncioses' => array(self::HAS_MANY, 'Anuncios', 'tiposanuncio_id'),
		);
	}
	 ...
	 * @return Tiposanuncio the static model class
	 */
