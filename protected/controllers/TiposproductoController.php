...
class TiposproductoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Tiposproducto'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('Tiposproducto');
	...
	{
		$model=new Tiposproducto('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Tiposproducto']))
			$model->attributes=$_GET['Tiposproducto'];
	...
	public function loadModel($id)
	{
		...
		$model=Tiposproducto::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tiposproducto-form')
		{
