...
class CoberturasController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('create','update','createPyme'),
                'roles'=>array('adm'),
			),
            array('allow', // allow authenticated user to perform 'create' and 'update' actions
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Coberturas'];
			if($model->save())
            {
    ...
    public function actionCreatePyme()
    {
        ...
        if(isset($_POST['Coberturas']))
        {
            ...
            if($model->save())
            {
                Yii::app()->user->setFlash('success',Yii::app()->params['saveSuccess']);
                //CRUDMODIFICATION
                $this->redirect(array('/Registros/viewPyme'));
        }
        }
...
//===============================================================
	...
	{
		$dataProvider=new CActiveDataProvider('Coberturas');
	...
	{
		$model=new Coberturas('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Coberturas']))
			$model->attributes=$_GET['Coberturas'];
	...
	public function loadModel($id)
	{
		...
		$model=Coberturas::model()->findByPk($id);
		if($model===null)
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='coberturas-form')
		{
