...
class AuthAssignmentController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['AuthAssignment']))
		{
			...
			if($model->save())
				//CRUDMODIFICATION 
                                $this->redirect(array('admin','id'=>$model->itemname.'|'.$model->userid));
		}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['AuthAssignment']))
		{
			...
			if($model->save())
                                 //CRUDMODIFICATION 
				 $this->redirect(array('view','id'=>$model->itemname.'|'.$model->userid));
		}
	...
	public function loadModel($id)
	{
               //CRUDMODIFICATION 
                $arrayId = explode('|',$id);
		$id = array('itemname' => $arrayId[0], 'userid' => $arrayId[1]);
