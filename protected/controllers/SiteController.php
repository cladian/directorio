...
class SiteController extends Controller
{
    ...
    {   $this->layout = '//layouts/column2';
        $modelAnuncios = new Anuncios('search');
        $modelAnuncios->unsetAttributes();  // clear any default values
        if (isset($_GET['Anuncios']))
            $modelAnuncios->attributes = $_GET['Anuncios'];
    ...
    public function actioncons()
    {
        ...
        $this->render('index/cons', array(
            'modelAnuncios' => $modelAnuncios,
        ));

    }
    public function actionpyme()
    {
