...
class ProveedoresController extends Controller
{
	...
	public function actionView($id)
	{
        ...
        $modelPyme=Pymes::model()->find('registros_id=? ',array($model->registros_idp));

        if (!$modelPyme)
            throw new CHttpException(404, 'Ocurrio un error contactese con el Administrador, no existe relación Proveedor->Pyme');
