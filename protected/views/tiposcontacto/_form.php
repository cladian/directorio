...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'ismail'); ?>
<!--		--><?php //echo $form->textField($model,'ismail'); ?>
        <?php echo $form->dropdownList($model,'ismail',
            array('1'=>'Si','0'=>'No'),
            array(
                'style' => "width: 100px;",
            )
        ); ?>
		<?php echo $form->error($model,'ismail'); ?>
	</div>
