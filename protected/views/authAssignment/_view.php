...
<div class="view">
	...
	<?php echo CHtml::link(CHtml::encode($data->itemname), array('view', 'id'=>$data->itemname.'|'.$data->userid)); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('userid')); ?>:</b>
	<?php echo CHtml::link(CHtml::encode($data->userid), array('view', 'id'=>$data->itemname.'|'.$data->userid)); ?>
	<br />
