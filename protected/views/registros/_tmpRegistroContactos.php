...
<P>Esta información será cargada como cátalogo de productos para cada una de las pymes del consorcio</P>
<P>P: habilitación de opción de actualización vía Dialog, deberia usar el mismo Form que se está usuando para la creación del registro
</P>
<?php
